...
#global agent, target_network, state_dim, n_actions
...
if __name__ == '__main__':
    ...
    loss = compute_td_loss(obs_batch, act_batch, reward_batch, next_obs_batch, agent, target_network,  is_done_batch, gamma=0.99,
                           check_shapes=True)
    loss.backward()
